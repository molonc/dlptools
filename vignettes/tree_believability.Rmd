...
The function to calculate the check is `dlptools::compute_tip_sibling_distances()`, and here I'll walk through an example of what's going on behind the scenes.
...
# something is conking on the website build, but I can't replicate it. Just
# storing and displaying the image.
# ggsave("/projects/molonc/aparicio_lab/bfurman/code/dlptools/vignettes/imgs/toy_heatmap_tree.png")
```

```{r, echo=FALSE, out.width="60%", out.height="50%", fig.align='center'}
knitr::include_graphics("imgs/toy_heatmap_tree.png")
```
...
# ggsave("imgs/toy_tree_nodes.png")
# making package build annoying, so just including saved plot below.
```

```{r, echo=FALSE, out.width="60%", out.height="50%", fig.align='center'}
knitr::include_graphics("imgs/toy_tree_nodes.png")
```
