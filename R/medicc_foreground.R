...
#' and tips.
#'
#' @param medicc_profiles_file file path. See read_medicc_profiles()
...
medicc_profiles_to_foreground <- function(
    medicc_profiles_file, phylogeny, cn_type = c("total", "allele")) {
  cn_type <- match.arg(cn_type)

  med_profiles <- read_medicc_profiles(medicc_profiles_file)
